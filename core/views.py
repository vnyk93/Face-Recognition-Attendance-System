...
# This is for profiles of employee 
...
# This is for details of employee
def details(request):
    try:
        last_face = LastFace.objects.last()
...
# This is for adding profiles of new employee
...
# This is used to delete employee's profile with given ID
def delete_profile(request,id):
    profile = Profile.objects.get(id=id)
    profile.delete()
    return redirect('profiles')

# This is used to clear attendance history
def clear_history(request):
    history = LastFace.objects.all()
    history.delete()
    return redirect('index')

# This is used to reset entry
def reset(request):
    profiles = Profile.objects.all()
    for profile in profiles:
        if profile.present == True:
